...
for w in worms:
	...
	f1 = cellFluoDF[ '1.ppp' ].ix[ cellFluoDF['1.ppp'].tidx == tdiv, '_488nm' ].values[0]
	b1 = cellFluoDF[ 'b_1' ].ix[ cellFluoDF[ 'b_1' ].tidx == tdiv, '_488nm' ].values[0]
	r1 = (f1-b1)/b1
	f4 = cellFluoDF[ '4.aaa' ].ix[ cellFluoDF['4.aaa'].tidx == tdiv, '_488nm' ].values[0]
...
print(data)
sc = ax1.scatter(data[:,0],data[:,1],c = dts,cmap = mycmap,s=60,linewidth=0,vmin=-1,vmax=1)
...
ax1.text(1.5,-3,'1->4',rotation=90,verticalalignment = 'center',fontsize = 18)
ax1.text(1.5,+3,'4->1',rotation=90,verticalalignment = 'center',fontsize = 18)

ax1.text(-1.3,+2.5,'final: 1>4',rotation=90,verticalalignment = 'center',fontsize = 18)
ax1.text(-1.3,-2.5,'final: 4>1',rotation=90,verticalalignment = 'center',fontsize = 18)

ax1.text(-.5,-4.8,'initial: 4>1',horizontalalignment = 'center',fontsize = 18)
ax1.text(+.5,-4.8,'initial: 1>4',horizontalalignment = 'center',fontsize = 18)
